    ...
    <table>
          ...
          <thead>
            <tr>
              ...
              }
              {
                ...
                <th colSpan={options.preColumns}></th>
              }                
              {
      ...
      <tbody>
        <tr styleName="colorRow">
          ...
          {
            options.preColumns && options.preColumns > 0 &&
            <td colSpan={options.preColumns}></td>
          }          
          {
            options.rowData.map((element, index) => (
          ...
          }
          {
            ...
            <td colSpan={(options.columns - (options.rowHeader ? options.rowData.length + 1 : options.rowData) - (options.preColumns ? options.preColumns : 0))}></td>
          }          
          </tr>    
      </tbody>          
    </table>
