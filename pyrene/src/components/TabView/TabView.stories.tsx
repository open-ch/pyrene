...
TabView.args = {
  ...
  directAccessTabs: 3,
  tabs: [
    { name: 'Tab 1', icon: 'home', renderCallback: () => <Placeholder label="tab 1" /> }, // eslint-disable-line react/display-name
    ...
    {
      name: 'Looooooooooooooooooooooooooooooooooooooong Name',
      renderCallback: () => <Placeholder label="tab 4" />,
    }, // eslint-disable-line react/display-name
    {
      name: 'Tab 5',
      icon: 'info',
      renderCallback: () => <Placeholder label="tab 5" />,
      disabled: true, // eslint-disable-line react/display-name
    },
  ],
};
