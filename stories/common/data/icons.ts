...
const icons = [
  ...
  { name: 'add', tags: ['add', 'plus', 'create', 'positive', 'addition', 'increase', 'new'] },
  {
    ...
    tags: ['add', 'plus', 'create', 'positive', 'addition', 'increase', 'new', 'outline'],
  },
  {
    name: 'addRound',
    tags: ['add', 'plus', 'create', 'positive', 'addition', 'increase', 'new', 'solid'],
  },
  {
    name: 'eye',
    tags: [
  ...
  {
    name: 'pin',
    tags: ['pin', 'pinboard', 'pushpin', 'marker', 'place', 'push pin', 'pin board', 'board'],
  },
  { name: 'play', tags: ['play', 'video', 'multimedia', 'control', 'media', 'film', 'movie'] },
  {
    name: 'skip',
    tags: ['skip', 'next', 'forward', 'onward', 'arrow', 'proceed', 'advance', 'position'],
  },
  ...
  {
    name: 'trusted',
    tags: ['trusted', 'approved', 'ok', 'accept', 'selected', 'approve', 'member'],
  },
  {
    name: 'block',
    tags: ['block', 'blocked', 'private', 'not', 'prevent', 'forbidden', 'banned', 'stop'],
  },
  ...
  {
    name: 'account',
    tags: ['account', 'user', 'person', 'people', 'avatar', 'contact', 'profile'],
  },
  ...
  {
    name: 'newWindow',
    tags: ['new window', 'window', 'new', 'open', 'tab', 'browser', 'application', 'export', 'app'],
  },
  {
    name: 'fastForward',
    tags: [
  ...
  {
    name: 'expand',
    tags: ['expand', 'open', 'enlarge', 'maximize', 'maximise', 'maxi', 'increase'],
  },
  {
    name: 'collapse',
    tags: ['collapse', 'close', 'minimize', 'minimise', 'mini', 'decrease', 'decrease'],
  },
  ...
  {
    name: 'download',
    tags: ['download', 'load', 'get', 'storage', 'file', 'save', 'bottom', 'downward', 'down'],
  },
  {
    name: 'edit',
    tags: [
  ...
  {
    name: 'locationSmall',
    tags: ['location', 'small', 'locationSmall', 'city', 'building', 'office'],
  },
  {
    name: 'locationMedium',
    tags: ['location', 'medium', 'locationMedium', 'city', 'building', 'office'],
  },
  ...
  {
    name: 'thumbsUp',
    tags: ['thumb', 'up', 'positive', 'great', 'yeah', 'plus', 'top', 'thumbs up'],
  },
  {
    name: 'path',
    tags: [
  ...
  {
    name: 'calendar',
    tags: ['calendar', 'date', 'day', 'schedule', 'event', 'today', 'week', 'month', 'year'],
  },
  {
    name: 'application',
    tags: ['application', 'browser', 'window', 'app', 'apps', 'interface', 'ui', 'frame', 'widget'],
  },
  {
    name: 'rule',
    tags: [
  ...
  { name: 'ticket', tags: ['ticket', 'check', 'ok', 'checklist', 'reports'] },
];
