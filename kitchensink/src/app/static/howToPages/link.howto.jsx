...
const LinkHTU = props => (
  <React.Fragment>
    ...
    <Paragraph title={'Paragraph Link'} >
      ...
      <DisplayBox>
        <div style={{ height: 192, width: 286, backgroundColor: 'white', display: 'flex', justifyContent: 'space-between', flexDirection: 'column', borderRadius: 4, boxShadow: '0 0 1px 0 rgba(0, 21, 44, 0.3)', boxSizing: 'border-box', padding: 24, flexShrink: 0}}>
          <div>[request <Link type={'inline'} path={'#'} label={'123798'}/>]</div>
        ...
        <div style={{ height: 192, width: 286, backgroundColor: 'white', borderRadius: 4, boxShadow: '0 0 1px 0 rgba(0, 21, 44, 0.3)', boxSizing: 'border-box', padding: 24, fontSize: 14, flexShrink: 0, lineHeight: 1.71 }}>
          Kogi Cosby sweater ethical squid irony disrupt, organic tote bag gluten-free <Link type={'inline'} path={'#'} label={'XOXO'} /> wolf typewriter mixtape small batch. DIY pickled four loko McSweeney's, Odd Future dreamcatcher plaid PBR&B single.
        </div>
      </DisplayBox>
    </Paragraph>
  </React.Fragment>
