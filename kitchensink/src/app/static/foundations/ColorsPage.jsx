...
const categoricalText = <div>
  Categorical (or qualitative) palettes are best when you want to distinguish discrete categories of data that do not have an inherent correlation.<br /><br />
  ...
  <div styleName="page">
    <div styleName="header">
      ...
      <div styleName="description">
        Maintaining consistent and engaging digital interfaces throughout Open Systems demands extended guidance around color usage. The following concepts are the foundation as we strive to achieve balance and harmony through our User Interface design.<br /><br />
        Our color palette contains primary, neutrals, interaction and status colors as well as color schemes used for data visualizations. They’ve been designed to work harmoniously with each other. <br /><br />
    ...
    <div styleName="topicContent">
      ...
      <Paragraph title="Neutral Colors">
        ...
        <ColorRow 
          ...
          description=''  
          rowHeader={{
            colors: [{ colorName: 'Primary Dark', name: 'neutral-500', darkFont: false, bordered: false, }, ],
            width: '30%',
          }}
      ...
      <Paragraph title="Semantic Colors">
        ...
        <ColorRow 
          ...
          description=''
          rowHeader={{
            colors: [{ colorName: 'Information', name: 'blue-500', darkFont: false, bordered: false,}, ],
            width: '200px',          
          }}   
        ...
        <ColorRow
          ...
          description=''     
          rowHeader={{
            colors: [{ colorName: 'Base', name: 'blue-500', darkFont: false, bordered: false, }, ],
            width: '200px',            
          }}
        ...
        <ColorRow
          ...
          description=''      
          rowHeader={{
            colors: [{ colorName: 'Base', name: 'green-600', darkFont: false, bordered: false, }, ],
            width: '200px',            
          }}
        ...
        <ColorRow 
          ...
          description=''       
          rowHeader={{
            colors: [{ colorName: 'Base', name: 'orange-600', darkFont: false, bordered: false, }, ],
            width: '200px',            
          }}
        ...
        <ColorRow 
          ...
          description=''            
          rowHeader={{
            colors: [{ colorName: 'Base', name: 'red-600', darkFont: false, bordered: false, }, ],
            width: '200px',            
          }}
        ...
        <ColorRow
          ...
          description=''         
          rowHeader={{
            colors: [{ colorName: 'Base', name: 'neutral-500', darkFont: false, bordered: false, }, ],
            width: '200px',
          }}
      ...
      <Paragraph title="Data Visualizations">
        ...
        <ColorRow 
          ...
          rowHeader={{
            colors: [{ colorName: 'Chart 1', name: 'chart-1', darkFont: false, bordered: false, }, ],
            width: '200px',            
          }}
