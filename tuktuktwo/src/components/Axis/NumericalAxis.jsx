    ...
    return (
      ...
      >
        <AxisLeft
          ...
          label={props.label}
          labelProps={{
            textAnchor: 'start', fontSize: 11, fontWeight: 400, fontFamily: 'FiraGO', fill: props.tickLabelColor, dx: '2.25em', lineHeight: '1.45',
          }}
  ...
  return (
    <Group>
      <AxisBottom
        ...
        label={props.label}
        labelProps={{
          textAnchor: 'middle', fontSize: 12, fontWeight: 400, fontFamily: 'FiraGO', fill: props.tickLabelColor, dy: '-1.8em', lineHeight: '1.3',
        }}
        stroke={props.strokeColor}
        tickStroke={props.tickLabelColor}
        tickFormat={props.tickFormat}
