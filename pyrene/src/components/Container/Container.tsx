import React, { FunctionComponent, useEffect, useRef, MouseEvent, useReducer } from 'react';
...
const Container: FunctionComponent<ContainerProps> = ({
  ...
  return (
    <div className={clsx(styles.container, { [styles.expanded]: state.expanded || !collapsible })}>
      ...
      >
        <span className={clsx(styles.title, 'unSelectable')}> {title}</span>
      ...
      <div
        ...
        style={{
          ...((state.expanded || !collapsible) && state.contentHeight
