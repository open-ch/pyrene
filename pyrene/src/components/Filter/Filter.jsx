...
export default class Filter extends React.PureComponent {
  ...
  render() {
    const {
      disabled, filters, negatable, onFilterSubmit,
    } = this.props;
    ...
    if (filters && filters.length > 0 && disabled === false) {
      return <FilterBar filters={filters} onFilterSubmit={onFilterSubmit} filterValues={this.props.filterValues} negatable={negatable} />;
    }
