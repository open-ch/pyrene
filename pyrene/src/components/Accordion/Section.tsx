...
const Section: React.FC<SectionProps> = ({
  ...
  return (
    <div className={classNames(styles.section, { [styles.expanded]: expanded, [styles.collapsed]: !expanded })}>
      <div className={styles.header} onClick={() => setExpanded(!expanded)}>
        ...
        <span className={classNames(styles.chevron, { 'pyreneIcon-chevronUp': expanded, 'pyreneIcon-chevronDown': !expanded })} />
      </div>
